...
vim.keymap.set("n", "<leader>z", "<cmd>tabnew %<CR>", utils.keymap_opts("Open current window in new tab"))
...
vim.keymap.set("n", "<leader>fc", "yiw/<C-r>+<CR>", utils.keymap_opts("Search in current buffer word under cursor"))
